...
public class InputUserSelectionFeaturesMapperTestBuilder {
    ...
    public static InputUserSelectionFeaturesMapperTestBuilder inputUserSelectionFeaturesMapper(List<String> features) {
        InputUserSelectionFeaturesMapperTestBuilder builder = new InputUserSelectionFeaturesMapperTestBuilder();
        return builder.with(features);
    }
    ...
    public InputUserSelectionFeaturesMapperTestBuilder with(List<String> features) {
    ...
    public InputUserSelectionFeaturesMapperTestBuilder select(List<String> features) {
        this.selected.addAll(features);
        return this;
    }
