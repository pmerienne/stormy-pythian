...
@Documentation(name = "Global feature mean", description = "Compute mean of a feature")
public class GlobalFeatureMean implements Component {
	...
	@InputStream(name = "in", type = FIXED_FEATURES, expectedFeatures = { @ExpectedFeature(name = SELECTED_FEATURE) })
	private Stream in;
	...
	public void init() {
		...
		out = in.stateQuery(counts, new SnapshotGet(), new Fields(MEAN_FIELD)) //
