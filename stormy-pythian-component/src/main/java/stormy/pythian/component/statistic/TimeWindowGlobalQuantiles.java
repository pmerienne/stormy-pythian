...
@Documentation(name = "Time window global quantiles", type = ANALYTICS)
public class TimeWindowGlobalQuantiles extends AbstractTimeWindowGlobalStatistic<TDigest> {
