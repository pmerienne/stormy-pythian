...
public class PythianToplogyConfiguration implements Validable {
    ...
    public ValidationResult validate() {
        ...
        for (ComponentConfiguration component : components) {
            result.include(component.validate());

            for (String mandatoryInputStream : component.retrieveMandatoryInputStreams()) {
                if (!from(connections).anyMatch(connectedTo(component, mandatoryInputStream))) {
                    result.add(mandatoryInputStream + " is mandatory");
                }
            }
        }
